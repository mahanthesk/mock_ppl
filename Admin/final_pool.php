...
<body>
    <div class="custom-header d-flex align-items-center justify-content-between px-4 py-2" style="background: rgba(255, 255, 255, 0.95); border-bottom: 1px solid rgba(2, 132, 199, 0.2); box-shadow: 0 4px 20px rgba(15, 42, 74, 0.05);">
        ...
        <div class="header-center text-center">
            ...
            <span class="small fw-bold text-uppercase" style="letter-spacing: 2px; font-size: 0.75rem; color: #64748b;">Pool Allocation Setup</span>
        </div>
    ...
    <div class="container my-5">
        <!-- <h2 class="text-center mb-2 heading-gold">Pool Setup</h2>
        <p class="text-center text-secondary mb-5" style="letter-spacing: 1px;">Assign teams to Elephant Pool &amp;
            Tiger Pool</p> -->
